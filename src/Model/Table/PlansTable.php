...
class PlansTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('channels')
            ->requirePresence('channels', 'create')
            ->notEmptyString('channels');

        $validator
            ->integer('internet_speed')
            ->requirePresence('internet_speed', 'create')
            ->notEmptyString('internet_speed');
        ...
        $validator
            ->integer('extratv_value')
            ->requirePresence('extratv_value', 'create')
            ->notEmptyString('extratv_value');
